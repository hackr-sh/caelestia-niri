...
PathView {
    ...
    readonly property int numItems: {
        ...
        let outerMargins = 0;
        if (panels.popouts.hasCurrent && panels.popouts.currentCenter + panels.popouts.nonAnimWidth / 2 > screen.width - content.implicitWidth / 2 - Config.border.thickness * 2)
